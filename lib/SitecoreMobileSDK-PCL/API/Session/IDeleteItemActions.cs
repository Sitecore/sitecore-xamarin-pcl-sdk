namespace Sitecore.MobileSDK.API.Session
{
  ...
  public interface IDeleteItemActions
  {
    ...
    /// </summary>
    /// <param name="request"><seealso cref="IDeleteItemsByIdRequest" />Delete item by Id request.</param>
    /// <param name="cancelToken">The cancel token, should be called in case when you want to terminate request execution.</param>
    /// <returns>
    ///   <seealso cref="Task{ScDeleteItemsResponse}" />Deleted items GUIDs list.
    /// </returns>
    ...
    /// </summary>
    /// <param name="request"><seealso cref="IDeleteItemsByPathRequest" />Delete item by Path request.</param>
    /// <param name="cancelToken">The cancel token, should be called in case when you want to terminate request execution.</param>
    /// <returns>
    ///   <seealso cref="Task{ScDeleteItemsResponse}" />Deleted items GUIDs list.
    /// </returns>
    ...
    /// </summary>
    /// <param name="request"><seealso cref="Task{IDeleteItemsByQueryRequest}" />Delete item by Query request.</param>
    /// <param name="cancelToken">The cancel token, should be called in case when you want to terminate request execution.</param>
    /// <returns>
    ///   <seealso cref="Task{ScDeleteItemsResponse}" />Deleted items GUIDs list.
    /// </returns>
