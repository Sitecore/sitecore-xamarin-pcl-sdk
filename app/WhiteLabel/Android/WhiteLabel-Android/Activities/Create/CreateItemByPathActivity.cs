namespace WhiteLabelAndroid.Activities.Create
{
  ...
  [Activity]
  public class CreateItemByPathActivity : BaseCreateItemActivity
  {
    ...
    protected override void OnCreate(Bundle bundle)
    {
      ...
      this.Title = GetString(Resource.String.text_create_item_by_path);

      this.ItemField.Hint = GetString(Resource.String.hint_item_parent_path);
    }
