namespace MobileSDKIntegrationTest
{
  ...
  public class SetLanguageDbVersionTest
  {
    ...
    private static async Task<ScItemsResponse> GetItemByIdWithRequestBuilder(IGetItemRequestParametersBuilder<IReadItemsByIdRequest> requestBuilder, IReadItemActions session)
    {
